...
const InnovationCategoriesSection = () => {
    ...
    useEffect(() => {
        const fetchInnovationCourses = async () => {
            setLoading(true);
            try {
                ...
                // Filter for Innovation courses only
                const innovationCourses = coursesList.filter(course => 
                    course.categories.toLowerCase() === 'Innovation'
                );

                console.log('Fetched Innovation Courses:', innovationCourses);
                setCourses(innovationCourses);
            } catch (error) {
                console.error("Error fetching Innovation courses:", error);
            } finally {
                setLoading(false);
            }
        };

        fetchInnovationCourses();
        setCurrentPage(1);
    }, [enrolledCourseIds]);
    ...
    useEffect(() => {
        ...
        console.log('Filtered Innovation Courses:', filtered.length);
        ...
        <div className="container" style={{ paddingBottom: 100 }}>
                ...
                <div className="col-12">
                    ...
                    >
                        <h1 className="display-4 fw-bold mb-3" style={{ fontSize: '3rem' }}>
                            Innovation Mastery Courses
                        </h1>
                        <p className="lead" style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                            Unlock creative thinking and drive innovation in your organization
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4 align-items-start">
                <div className="col-md-8 col-sm-12">
                    <SearchBar placeholder="Search Innovation courses..." onSearch={setSearchQuery} />
                </div>
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 style={{ color: '#2c3e50', fontFamily: "'Acme', sans-serif" }}>
                            {filteredCourses.length} Innovation Course{filteredCourses.length !== 1 ? 's' : ''} Found
                        </h5>
                    </div>
                </div>
            </div>
...
export default function InnovationCategoriesPage() {
    return (
        <>
            <Head>
                <title>DG Next - Innovation Courses</title>
                <meta name="description" content="Master innovation with our comprehensive courses. Learn creative thinking, design thinking, and disruptive innovation strategies." />
                <meta name="keywords" content="Innovation, Creative Thinking, Design Thinking, Disruptive Innovation, Innovation Management" />
