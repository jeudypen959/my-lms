...
const StrategyCategoriesSection = () => {
    ...
    useEffect(() => {
        const fetchStrategyCourses = async () => {
            setLoading(true);
            try {
                ...
                // Filter for Strategy courses
                const strategyCourses = coursesList.filter(course => 
                    course.categories.toLowerCase().includes('strategy')
                );

                console.log('Fetched Strategy Courses:', strategyCourses);
                setCourses(strategyCourses);
            } catch (error) {
                console.error("Error fetching Strategy courses:", error);
            } finally {
                setLoading(false);
            }
        };

        fetchStrategyCourses();
        setCurrentPage(1);
    }, [enrolledCourseIds]);
    ...
    useEffect(() => {
        ...
        console.log('Filtered Strategy Courses:', filtered.length);
        ...
        <div className="container" style={{ paddingBottom: 100 }}>
                ...
                <div className="col-12">
                    ...
                    >
                        ...
                        <p className="lead" style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                            Master strategic planning and business strategy to drive success
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4 align-items-start">
                <div className="col-md-8 col-sm-12">
                    <SearchBar placeholder="Search Strategy courses..." onSearch={setSearchQuery} />
                </div>
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 style={{ color: '#2c3e50', fontFamily: "'Acme', sans-serif" }}>
                            {filteredCourses.length} Strategy Course{filteredCourses.length !== 1 ? 's' : ''} Found
                        </h5>
                    </div>
                </div>
            </div>
...
export default function StrategyCategoriesPage() {
    return (
        <>
            <Head>
                <title>DG Next - Strategy Courses</title>
                <meta name="description" content="Master strategic planning with our comprehensive courses. Learn business strategy, corporate strategy, and strategic management." />
                <meta name="keywords" content="Strategy, Strategic Planning, Business Strategy, Corporate Strategy, Strategic Management" />
