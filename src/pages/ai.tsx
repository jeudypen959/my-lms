...
const AICategoriesSection = () => {
    ...
    useEffect(() => {
        const fetchAICourses = async () => {
            ...
            try {
                ...
                // Filter for AI courses
                const aiCourses = coursesList.filter(course => 
                    course.categories === 'AI' ||
                    course.categories === 'Artificial Intelligence'
                );

                console.log('Fetched AI Courses:', aiCourses);
    ...
    useEffect(() => {
        ...
        console.log('Filtered AI Courses:', filtered.length);
        ...
        <div className="container" style={{ paddingBottom: 100 }}>
                ...
                <div className="col-12">
                    ...
                    >
                        <h1 className="display-4 fw-bold mb-3" style={{ fontSize: '3rem' }}>
                            AI & Machine Learning Mastery Courses
                        </h1>
                        <p className="lead" style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                            Explore cutting-edge AI technologies and transform the future
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4 align-items-start">
                <div className="col-md-8 col-sm-12">
                    <SearchBar placeholder="Search AI courses..." onSearch={setSearchQuery} />
                </div>
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 style={{ color: '#2c3e50', fontFamily: "'Acme', sans-serif" }}>
                            {filteredCourses.length} AI Course{filteredCourses.length !== 1 ? 's' : ''} Found
                        </h5>
                    </div>
                </div>
            </div>
...
export default function AICategoriesPage() {
    return (
        <>
            <Head>
                <title>DG Next - AI Courses</title>
                <meta name="description" content="Master artificial intelligence with our comprehensive AI courses. Learn machine learning, deep learning, natural language processing, and AI ethics." />
                <meta name="keywords" content="AI, Artificial Intelligence, Machine Learning, Deep Learning, Natural Language Processing, Computer Vision, AI Ethics, Data Science" />
