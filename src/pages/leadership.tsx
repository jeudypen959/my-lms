...
const LeadershipCategoriesSection = () => {
    ...
    useEffect(() => {
        const fetchLeadershipCourses = async () => {
            setLoading(true);
            try {
                ...
                // Filter for Leadership courses
                const leadershipCourses = coursesList.filter(course => 
                    course.categories.toLowerCase().includes('leadership') ||
                    course.categories.toLowerCase().includes('Ladership')
                );

                console.log('Fetched Leadership Courses:', leadershipCourses);
                setCourses(leadershipCourses);
            } catch (error) {
    ...
    useEffect(() => {
        ...
        console.log('Filtered Leadership Courses:', filtered.length);
        ...
        <div className="container" style={{ paddingBottom: 100 }}>
            ...
            <div className="row mb-4 align-items-start">
                <div className="col-md-8 col-sm-12">
                    <SearchBar placeholder="Search Leadership courses..." onSearch={setSearchQuery} />
                </div>
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 style={{ color: '#2c3e50', fontFamily: "'Acme', sans-serif" }}>
                            {filteredCourses.length} Leadership Course{filteredCourses.length !== 1 ? 's' : ''} Found
                        </h5>
                    </div>
                </div>
            </div>
...
export default function LeadershipCategoriesPage() {
    return (
        <>
            <Head>
                <title>DG Next - Leadership Courses</title>
                <meta name="description" content="Master leadership skills with our comprehensive courses. Learn team management, executive leadership, and organizational strategies." />
                <meta name="keywords" content="Leadership, Management, Team Building, Organizational Leadership, Executive Leadership" />
