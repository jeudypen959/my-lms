...
const FinanceCategoriesSection = () => {
    ...
    useEffect(() => {
        const fetchFinanceCourses = async () => {
            setLoading(true);
            try {
                ...
                // Filter for Finance courses
                const financeCourses = coursesList.filter(course => 
                    course.categories.toLowerCase().includes('Finance') ||
                    course.courseTitle.toLowerCase().includes('finance') ||
                    course.categories.toLowerCase().includes('Personal Finance')
                );

                console.log('Fetched Finance Courses:', financeCourses);
    ...
    useEffect(() => {
        ...
        console.log('Filtered Finance Courses:', filtered.length);
        ...
        <div className="container" style={{ paddingBottom: 100 }}>
                ...
                <div className="col-12">
                    ...
                    >
                        <h1 className="display-4 fw-bold mb-3" style={{ fontSize: '3rem' }}>
                            Finance Mastery Courses
                        </h1>
                        <p className="lead" style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                            Master financial management and investment strategies
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4 align-items-start">
                <div className="col-md-8 col-sm-12">
                    <SearchBar placeholder="Search Finance courses..." onSearch={setSearchQuery} />
                </div>
                ...
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5 style={{ color: '#2c3e50', fontFamily: "'Acme', sans-serif" }}>
                            {filteredCourses.length} Finance Course{filteredCourses.length !== 1 ? 's' : ''} Found
                        </h5>
                    </div>
                </div>
            </div>
...
export default function FinanceCategoriesPage() {
    return (
        <>
            <Head>
                <title>DG Next - Finance Courses</title>
                <meta name="description" content="Master financial management with our comprehensive courses. Learn accounting, investment strategies, and budgeting." />
                <meta name="keywords" content="Finance, Financial Management, Accounting, Investment, Budgeting" />
